...
import { Brain, Cable, Search } from 'lucide-react';
...
export default function Courses() {
    ...
    useEffect(() => {
        const get = async() => {
            await axios.get(`${process.env.NEXT_PUBLIC_HOST}/api/getCourses`, {
            }).then((response) => {
        ...
        <div className='grid grid-cols-[1fr,0fr,4fr] h-screen'>
            ...
            <div className='flex h-full overflow-y-scroll no-scrollbar'>
                ...
                >
                    ...
                    <ListItemButton onClick={() => { handleClick(0) }}>
                        ...
                        <ListItemText primary="Computer Science & Engg." />
                    ...
                    <ListItemButton onClick={() => { handleClick(2) }}>
                        ...
                        <ListItemText primary="Electrical Engg." />
            ...
            <div className='p-4 pt-0 h-full overflow-y-scroll no-scrollbar flex flex-col gap-8'>
                ...
                <div className='grid gap-5 grid-cols-3 h-full'>
                    {/* card  */}
                    {data.map((dt)=>{return <Card className='h-[315px] bg-purple-100 rounded-lg shadow-shadow'>
                        <CardContent className='p-0 flex flex-col gap-3'>
                            <img className='h-2/5 w-full rounded-lg' src={`${dt.imgUrl}`} />
                            {/* content  */}
                            <div className='p-3 pt-1 flex flex-col gap-3'>
                                <h2 className='font-bold text-l font-Roboto'>{dt.name}</h2>
